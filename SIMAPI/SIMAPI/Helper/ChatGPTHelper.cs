...
namespace SIMAPI.Helper
{
    ...
    {
        public async Task<object> GenerateQuestion(Question model, string apiKey, string url, string chatGPTModel)
        {
        ...
        private string GenerateRquest(Question model, string chatGPTModel)
        {
            ...
            var userContent = $"Generate {model.NumberOfQuestion} {model.DifficultyLevel.GetDisplayName()} multiple-choice question on '{model.Topics.Topic}' in {model.Topics.Subject}.\n" +
